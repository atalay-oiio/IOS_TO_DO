...
const paths = {
  ...
  fingerprint: (
    <path d="M4.2 12.4a7.8 7.8 0 0 1 12-6.6M19.6 11.4a7.8 7.8 0 0 0-1.4-3.2M6.8 19.6A9.6 9.6 0 0 0 8.6 14a3.4 3.4 0 0 1 6.8 0c0 2.2-.3 4.3-1 6.3M12 8.6A5.4 5.4 0 0 0 6.6 14c0 1.6-.3 3.2-.9 4.7M17.4 14c0 2.6-.4 4.5-1.1 6.6" />
  ),
  delete: <path d="M9.6 5.5H20a1.6 1.6 0 0 1 1.6 1.6v9.8A1.6 1.6 0 0 1 20 18.5H9.6L3 12zM13 9.6l4.6 4.8M17.6 9.6 13 14.4" />,
  wifiOff: (
    <>
